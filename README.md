...
Fullscreen
Overview of the API part of the project AirBnB Clone
...
Each time a new User object is created or password updated, the password is hashed to a [MD5 value](https://docs.python.org/3.4/library/hashlib.html)
